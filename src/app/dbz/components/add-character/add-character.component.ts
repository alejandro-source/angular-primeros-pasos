...
export class AddCharacterComponent {
 ...
 public onNewCharacter: EventEmitter<Character> = new EventEmitter();
    ...
    emitCharacter():void{
      ...
      if (this.character.name.length === 0) return;//Si no hay nombre, no hace nada

      this.onNewCharacter.emit(this.character); //Envia el personaje al componente padre

      this.character={ name: '', power:0}; //Resetea el formulario
